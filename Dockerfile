...
COPY . /usr/src/wordpress/wp-content/themes/msstheme2/

COPY wp-config-cache.php /usr/src/wordpress/wp-content/
# Install composer devs onto the container
RUN  cp /usr/src/wordpress/wp-content/themes/msstheme2/composer.json /usr/src/wordpress/composer.json && \
	cp /usr/src/wordpress/wp-content/themes/msstheme2/robots.txt /usr/src/wordpress/robots.txt && \
